        ...
        <View style={styles.info}>
          <View style={styles.titleRow}>
            ...
            <Text style={[styles.fileName, { color: themeColors.text }]} numberOfLines={1}>
              {currentData.isLoading ? 'Rendering...' : (currentData.file?.startsWith('hybrid:') ? (currentFileMetadata?.original_name || currentData.file) : currentData.file || '').replace(/\.midi?$/i, '') || 'Unknown'}
            </Text>
          </View>
